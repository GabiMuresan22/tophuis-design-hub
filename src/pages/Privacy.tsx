        ...
        <div className="container-wide max-w-3xl">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 text-muted-foreground mb-6 space-y-2">
              ...
              <li><strong>{t("JotForm", "JotForm")}:</strong> {t("Ons contactformulier wordt verwerkt via JotForm Inc. (VS). De door u ingediende gegevens (naam, e-mail, bericht) worden opgeslagen op JotForm-servers en doorgestuurd naar ons. Zie het privacybeleid van JotForm: jotform.com/privacy/.", "Our contact form is processed by JotForm Inc. (USA). Data you submit (name, email, message) is stored on JotForm servers and forwarded to us. See JotForm's privacy policy: jotform.com/privacy/.")}</li>
              <li><strong>{t("Google Maps", "Google Maps")}:</strong> {t("Onze contactpagina toont een ingesloten Google Maps-kaart van Google LLC (VS). Google kan daardoor mogelijk uw IP-adres registreren. Zie het privacybeleid van Google: policies.google.com/privacy.", "Our contact page embeds a Google Maps map from Google LLC (USA). Google may thereby record your IP address. See Google's privacy policy: policies.google.com/privacy.")}</li>
            </ul>
